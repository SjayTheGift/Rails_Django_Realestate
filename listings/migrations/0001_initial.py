    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('Eastern Cape', 'Eastern Cape'), ('Free State', 'Free State'), ('Gauteng', 'Gauteng'), ('KwaZulu-Natal', 'Kwazulu Natal'), ('Limpopo', 'Limpopo'), ('Mpumalanga', 'Mpumalanga'), ('Northern Cape', 'Northern Cape'), ('North West', 'Northwest'), ('Western Cape', 'Western Cape')], default='Eastern Cape', max_length=50)),
